...
const char * const BITCOIN_CONF_FILENAME = "mitecoin.conf";
const char * const BITCOIN_PID_FILENAME = "mitecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mitecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mitecoin";
#else
    // Unix
    return pathRet / ".mitecoin";
#endif
#endif
}
