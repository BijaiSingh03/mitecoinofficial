...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mitecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mitecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mitecoin transaction") + "\n" +
              "  mitecoin-tx [options] -create [commands]   " + _("Create hex-encoded mitecoin transaction") + "\n" +
              "\n";
