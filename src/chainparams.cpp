...
{
    const char* pszTimestamp = "Finals MVP Ladder: Khris Middleton enters the race";
    const CScript genesisOutputScript = CScript() << ParseHex("031984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1626487425, 2001226190, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe65abfae26dc2853f9231622134c461293c6014c0ee27dab7f85853a1f6468ae"));
        assert(genesis.hashMerkleRoot == uint256S("0x356419bf89c34ac0d9da28e5885796f177fb6dd75c111d3da23b43552bb0482e"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("34.72.82.67", "34.72.82.67", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("mitecointools.com", "dnsseed.mitecointools.com"));
        //vSeeds.push_back(CDNSSeedData("mitecoinpool.org", "dnsseed.mitecoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xe65abfae26dc2853f9231622134c461293c6014c0ee27dab7f85853a1f6468ae"))
        ...
        chainTxData = ChainTxData{
            ...
            1626487425, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1626487425, 483636, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3557e1adc744d00f096475b79d65771f44fe183c2f5ee4a1d262515c8b81133d"));
        assert(genesis.hashMerkleRoot == uint256S("0x356419bf89c34ac0d9da28e5885796f177fb6dd75c111d3da23b43552bb0482e"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("181.36.88.159", "181.36.88.159"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mitecoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x3557e1adc744d00f096475b79d65771f44fe183c2f5ee4a1d262515c8b81133d")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1626487425, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbb2bc5da1cd3b38e975ce54d74c4d048f9102ebb7d6d68af77b28f70b0a65a71"));
        assert(genesis.hashMerkleRoot == uint256S("0x356419bf89c34ac0d9da28e5885796f177fb6dd75c111d3da23b43552bb0482e"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xbb2bc5da1cd3b38e975ce54d74c4d048f9102ebb7d6d68af77b28f70b0a65a71"))
        };
