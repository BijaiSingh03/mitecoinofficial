...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mitecoin-project/mitecoin>";
    const std::string URL_WEBSITE = "<https://mitecoin.org>";
